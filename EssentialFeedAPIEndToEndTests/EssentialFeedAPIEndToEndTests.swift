...
//
//  Created by Leandro Fournier on 3/30/23.
//
...
final class EssentialFeedAPIEndToEndTests: XCTestCase {
    ...
    func test_endToEndTestServerGETFeedResult_matchesFixedTestAccountData() {
        ...
        case let .success(imageFeed)?:
            ...
            // Instead of using a foreach, they prefer to manually add each one of them
            // to get the exact item where a failing occurs
    ...
    func test_endToEndTestServerGETFeedImageDataResult_matchesFixedTestAccoundData() {
